        ...
        public List<Expediente> ListarExpediente()
        {
            ...
            try
            {
                ...
                while (dr.Read()) //Recorre cada registro
                {
                    ...
                    exp.EnferICHepatitis = Convert.ToChar(dr["EnferICHepatitis"].ToString());
                    exp.EnferICSifilis = Convert.ToChar(dr["EnferICSifilis"].ToString());
                    exp.EnferICColera = Convert.ToChar(dr["EnferICColera"].ToString());
                    exp.EnferICTosferina = Convert.ToChar(dr["EnferICTosferina"].ToString());
                    exp.EnferICSarampion = Convert.ToChar(dr["EnferICSarampion"].ToString());
                    exp.EnferICVaricela = Convert.ToChar(dr["EnferICVaricela"].ToString());
                    exp.EnferICRubeola = Convert.ToChar(dr["EnferICRubeola"].ToString());
                    exp.EnferICPariotiditis = Convert.ToChar(dr["EnferICPariotiditis"].ToString());
                    exp.EnferICMeningitis = Convert.ToChar(dr["EnferICMeningitis"].ToString());
                    exp.EnferICImpetigo = Convert.ToChar(dr["EnferICImpetigo"].ToString());
                    exp.EnferICTifoidea = Convert.ToChar(dr["EnferICTifoidea"].ToString());
                    exp.EnferICMalaria = Convert.ToChar(dr["EnferICMalaria"].ToString());
                    exp.EnferICEscabiasis = Convert.ToChar(dr["EnferICEscabiasis"].ToString());
                    exp.EnferICTina = Convert.ToChar(dr["EnferICTina"].ToString());
                    exp.EnferHAlergias = Convert.ToChar(dr["EnferHAlergias"].ToString());
                    exp.EnferHDiabetes = Convert.ToChar(dr["EnferHDiabetes"].ToString());
                    exp.EnferHHipertension = Convert.ToChar(dr["EnferHHipertension"].ToString());
                    exp.EnferHReumatica = Convert.ToChar(dr["EnferHReumatica"].ToString());
                    exp.EnferHRenales = Convert.ToChar(dr["EnferHRenales"].ToString());
                    exp.EnferHOculares = Convert.ToChar(dr["EnferHOculares"].ToString());
                    exp.EnferHCardiacas = Convert.ToChar(dr["EnferHCardiacas"].ToString());
                    exp.EnferHHepatica = Convert.ToChar(dr["EnferHHepatica"].ToString());
                    exp.EnferHMusculares = Convert.ToChar(dr["EnferHMusculares"].ToString());
                    exp.EnferHMalCongenitas = Convert.ToChar(dr["EnferHMalCongenitas"].ToString());
                    exp.EnferHDesorMentales = Convert.ToChar(dr["EnferHDesorMentales"].ToString());
